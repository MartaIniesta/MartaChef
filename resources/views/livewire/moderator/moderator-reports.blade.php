            ...
            <table class="w-full border-collapse border border-gray-300">
                ...
                @foreach ($reports as $report)
                    <tr class="text-center">
                        <!-- Usamos los alias que definimos en la consulta -->
                        <td class="border py-3">{{ $report->reported_name }}</td>
                        <td class="border py-3">{{ $report->reporter_name }}</td>
                        ...
                        <td class="border py-3">
                            <a href="{{ route('user-history', $report->reported_id) }}" class="text-blue-500 hover:underline">
                                {{ __('View history') }}
                            </a>
                        </td>
